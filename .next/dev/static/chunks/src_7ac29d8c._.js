    ...
    const fetchProfile = async (userId)=>{
        try {
            ...
            if (data) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Profile not found. Please sign up again.');
            }
        } catch (error) {
    ...
    const signUp = async (email, password, name, role)=>{
        try {
            ...
            if (data.user) {
                ...
                await fetchProfile(data.user.id);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Account created successfully! Please check your email to verify your account.');
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Failed to sign up');
            throw error;
        } finally{
            setLoading(false);
        }
...
_s(CreateClassModal, "/qsV0P8U1AtwYUQj5sEbymu4xQA=");
_c = CreateClassModal;
var _c;
...
_s(TeacherDashboard, "OfWCP+rsGJuW8SvqXJTw5osd8Pk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
function StudentDashboard({ user, onLogout, isDarkMode, toggleDarkMode }) {
    ...
    const handleJoinClass = (code)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Joined class successfully!');
    };
...
_s(StudentDashboard, "eGUrf3Mh5fl7nFEM2j/thJUK+k4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_7ac29d8c._.js.map